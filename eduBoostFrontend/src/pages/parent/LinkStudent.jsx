...
export default function LinkStudent() {
  ...
  // Remove ROLE_ prefix if exists for comparison
      ...
      <>
        <div className="auth-card glass link-student-card">
          ...
          <p className="auth-subtitle">
            Bạn cần đăng nhập với tài khoản phụ huynh để kết nối với con em
          </p>
          ...
          <div className="auth-gate">
            ...
            >
              Vui lòng đăng nhập hoặc đăng ký tài khoản phụ huynh để sử dụng mã
              mời kết nối với học sinh.
            </p>
  ...
  return (
    <>
      <div className="auth-card glass link-student-card">
        ...
        <p className="auth-subtitle">
          Nhập mã mời từ giáo viên để kết nối với con em
        </p>

        <form onSubmit={handleLink} className="auth-form">
          <div className="form-group">
            <label>
              Mã mời <span className="required">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="form-group">
            <label>
              Mối quan hệ với học sinh <span className="required">*</span>
            </label>
            <select
              value={relationship}
