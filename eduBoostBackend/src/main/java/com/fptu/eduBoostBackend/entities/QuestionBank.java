...
@Table(name = "question_bank", indexes = {
    @Index(name = "idx_qb_lesson_cognitive_source", columnList = "lesson_id, cognitive_level_id, source_type"),
    @Index(name = "idx_qb_lesson_cognitive", columnList = "lesson_id, cognitive_level_id"),
