...
public class ScienceGrade8Initializer {
    ...
    public void init() {
        ...
        Chapter chap1 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(1)
        ...
        Chapter chap2 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(2)
        ...
        Chapter chap3 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(3)
        ...
        Chapter chap4 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(4)
        ...
        // Chương 5: Điện
        Chapter chap5 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(5)
                .chapterName("Điện").description("Chương 5: Điện").build());
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(20).lessonName("Nhiễm điện do cọ xát").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(30).lessonName("Khái quát về cơ thể người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(31).lessonName("Hệ vận động ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(32).lessonName("Dinh dưỡng và tiêu hóa ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(33).lessonName("Máu và hệ tuần hoàn ở cơ thể người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(34).lessonName("Hệ hô hấp ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(35).lessonName("Hệ bài tiết ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(36).lessonName("Điều hòa môi trường trong của cơ thể người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(37).lessonName("Hệ thần kinh và các giác quan ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(38).lessonName("Hệ nội tiết ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(39).lessonName("Da và điều hòa thân nhiệt ở người").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(40).lessonName("Sinh sản ở người").build());

        // Chương 8: Sinh vật và môi trường
        Chapter chap8 = chapterRepository.save(Chapter.builder().subject(sc).gradeLevel(8).chapterNumber(8)
                .chapterName("Sinh vật và môi trường").description("Chương 8: Sinh vật và môi trường").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(41).lessonName("Môi trường và các nhân tố sinh thái").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(42).lessonName("Quần thể sinh vật").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(43).lessonName("Quần xã sinh vật").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(44).lessonName("Hệ sinh thái").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(45).lessonName("Sinh quyển").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(46).lessonName("Cân bằng tự nhiên").build());
        lessonRepository.save(Lesson.builder().chapter(chap8).lessonNumber(47).lessonName("Bảo vệ môi trường").build());
    }
}