...
public class ChemistryGrade10Initializer {
    ...
    public void init() {
        ...
        lessonRepository.save(Lesson.builder().chapter(chap1).lessonNumber(1)
                .lessonName("Thành phần của nguyên tử").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap1).lessonNumber(3)
                .lessonName("Cấu trúc lớp vỏ electron nguyên tử").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap2).lessonNumber(4)
                .lessonName("Cấu tạo của bảng tuần hoàn các nguyên tố hóa học").build());
        lessonRepository.save(Lesson.builder().chapter(chap2).lessonNumber(5)
                .lessonName("Xu hướng biến đổi một số tính chất của nguyên tử các nguyên tố trong một chu kì và trong một nhóm").build());
        lessonRepository.save(Lesson.builder().chapter(chap2).lessonNumber(6)
                .lessonName("Xu hướng biến đổi thành phần và một số tính chất của hợp chất trong một chu kì").build());
        lessonRepository.save(Lesson.builder().chapter(chap2).lessonNumber(7)
                .lessonName("Định luật bảo toàn. Ý nghĩa của bảng tuần hoàn các nguyên tố hóa học").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap4).lessonNumber(12)
                .lessonName("Phản ứng oxi hóa - khử").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(13)
                .lessonName("Biến thiên enthalpy trong các phản ứng hóa học").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(14)
                .lessonName("Tốc độ phản ứng").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(15)
                .lessonName("Nhóm halogen").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(16)
                .lessonName("Hydrogen halide. Muối halide").build());
    }
}