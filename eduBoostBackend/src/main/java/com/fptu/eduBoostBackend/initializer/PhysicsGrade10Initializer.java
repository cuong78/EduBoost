...
public class PhysicsGrade10Initializer {
    ...
    public void init() {
        ...
        lessonRepository.save(Lesson.builder().chapter(chap4).lessonNumber(20)
        ...
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(25).lessonName("Động lượng").build());
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(26).lessonName("Định luật bảo toàn động lượng").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(27).lessonName("Động học của chuyển động tròn đều").build());
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(28).lessonName("Lực hướng tâm và gia tốc hướng tâm").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(29).lessonName("Biến dạng của vật rắn").build());
        lessonRepository.save(Lesson.builder().chapter(chap7).lessonNumber(30).lessonName("Khối lượng riêng. Áp suất chất lỏng").build());
    }
