...
public class ChemistryGrade11Initializer {
    ...
    public void init() {
        ...
        lessonRepository.save(Lesson.builder().chapter(chap1).lessonNumber(1)
                .lessonName("Khái niệm về cân bằng hóa học").build());
        lessonRepository.save(Lesson.builder().chapter(chap1).lessonNumber(2)
                .lessonName("Cân bằng trong dung dịch nước").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap3).lessonNumber(10)
                .lessonName("Hợp chất hữu cơ và hóa học hữu cơ").build());
        lessonRepository.save(Lesson.builder().chapter(chap3).lessonNumber(11)
                .lessonName("Phương pháp tách biệt và tinh chế hợp chất hữu cơ").build());
        lessonRepository.save(Lesson.builder().chapter(chap3).lessonNumber(12)
                .lessonName("Công thức phân tử hợp chất hữu cơ").build());
        lessonRepository.save(Lesson.builder().chapter(chap3).lessonNumber(13)
                .lessonName("Cấu tạo hóa học hợp chất hữu cơ").build());
        ...
        lessonRepository.save(Lesson.builder().chapter(chap4).lessonNumber(16)
                .lessonName("Hydrocarbon không no").build());
        lessonRepository.save(Lesson.builder().chapter(chap4).lessonNumber(17)
                .lessonName("Arene (Hydrocarbon thơm)").build());
        lessonRepository.save(Lesson.builder().chapter(chap4).lessonNumber(18)
        ...
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(19)
                .lessonName("Dẫn xuất halogen").build());
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(20)
                .lessonName("Alcohol").build());
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(21)
                .lessonName("Phenol").build());
        lessonRepository.save(Lesson.builder().chapter(chap5).lessonNumber(22)
        ...
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(23)
                .lessonName("Hợp chất carbonyl").build());
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(24)
                .lessonName("Carboxylic acid").build());
        lessonRepository.save(Lesson.builder().chapter(chap6).lessonNumber(25)
