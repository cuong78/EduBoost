...
public class MathGrade7Initializer {
    ...
    public void init() {
        ...
        lessonRepository.save(Lesson.builder().chapter(chap9).lessonNumber(4)
                .lessonName("Sự đồng quy của ba đường trung tuyến, ba đường phân giác trong một tam giác").build());
        lessonRepository.save(Lesson.builder().chapter(chap9).lessonNumber(5)
        ...
        lessonRepository.save(Lesson.builder().chapter(chap10).lessonNumber(1)
                .lessonName("Hình hộp chữ nhật và hình lập phương").build());
        lessonRepository.save(Lesson.builder().chapter(chap10).lessonNumber(2)
